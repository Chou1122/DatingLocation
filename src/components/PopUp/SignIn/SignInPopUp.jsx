...
export const SignInPopUp = (props) => {
  const { onExitPress, onSignUpPress } = props;
    ...
    <div style={styles.layout}>
      <div style={styles.popupWrapper}>
        ...
        <div style={styles.labelWrapper}>
          <p style={styles.textLabel}>Welcome Back!</p>
        </div>
        ...
        <div style={styles.passwordWrapper}>
          <div style={styles.passwordLabel}>
            <p style={styles.passwordLabelText}>Password</p>
          </div>
        ...
        <div style={styles.btnSignInWrapper}>
          <button className={"signInBtn"}>
            <text style={styles.textSignInBtn}>Sign in</text>
          </button>
        </div>

        <div style={styles.signUpLabelWrapper}>
          <div style={styles.lineThought}></div>
          <p style={styles.textSignUpLabel}>Not have an account?</p>
          <div style={styles.lineThought}></div>
        </div>
